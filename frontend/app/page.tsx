    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 sm:pt-20 sm:pb-32">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white">
              <span className="text-gray-900 dark:text-white">Честная аренда</span>
              <br />
              <span className="text-primary-600 dark:text-primary-400">начинается здесь</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Читай отзывы арендаторов, смотри оценки по адресам на карте и принимай решение о съёме жилья на основе реального опыта.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Независимая платформа отзывов об аренде. Твой опыт — чья-то безопасность.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/80 p-6 sm:p-8 border border-gray-100 dark:border-gray-700/50 hover:border-primary-200 dark:hover:border-primary-800 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Карта отзывов</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Смотри оценки и отзывы по адресам на интерактивной карте. Удобный поиск по городу и улице.
              </p>
            </div>
            <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/80 p-6 sm:p-8 border border-gray-100 dark:border-gray-700/50 hover:border-primary-200 dark:hover:border-primary-800 transition-colors">
              <div className="w-12 h-12 rounded-xl bg-primary-100 dark:bg-primary-900/50 flex items-center justify-center text-primary-600 dark:text-primary-400 mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Оценки по критериям</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Чистота, шум, соседи, инфраструктура, транспорт — объективные оценки по важным аспектам жизни в съёмном жилье.
              </p>
            </div>
            <div className="rounded-2xl bg-gray-50 dark:bg-gray-800/80 p-6 sm:p-8 border border-gray-100 dark:border-gray-700/50 hover:border-primary-200 dark:hover:border-primary-800 transition-colors sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Безопасный выбор</h3>
              <p className="text-gray-600 dark:text-gray-300">
                Правдивые отзывы помогают избежать нежелательного жилья и недобросовестных арендодателей.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-gray-50 dark:bg-gray-900/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Три простых шага к осознанному выбору жилья
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 md:gap-6">
            <div className="relative flex flex-col items-center text-center">
              <div className="w-14 h-14 rounded-full bg-primary-600 dark:bg-primary-500 text-white font-bold text-xl flex items-center justify-center shadow-lg shadow-primary-500/30">
                1
              </div>
              <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Открой карту</h3>
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Выбери город или введи адрес. Смотри маркеры с количеством отзывов по домам.
              </p>
            </div>
            <div className="relative flex flex-col items-center text-center">
              <div className="w-14 h-14 rounded-full bg-primary-600 dark:bg-primary-500 text-white font-bold text-xl flex items-center justify-center shadow-lg shadow-primary-500/30">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Читай отзывы</h3>
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Заходи на страницу адреса — оценки по критериям и комментарии тех, кто уже жил в этом доме.
              </p>
            </div>
            <div className="relative flex flex-col items-center text-center">
              <div className="w-14 h-14 rounded-full bg-primary-600 dark:bg-primary-500 text-white font-bold text-xl flex items-center justify-center shadow-lg shadow-primary-500/30">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Делись опытом</h3>
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                После съёма оставь свой отзыв — помоги другим сделать безопасный выбор.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-white dark:bg-gray-800/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-gray-600 dark:text-gray-400">— Миссия ArendaRate</p>
          <div className="mt-10">
            <Link
              href="/about"
              className="text-primary-600 dark:text-primary-400 font-semibold hover:underline"
            >
              Подробнее о проекте и уставе →
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-primary-600 to-primary-800 dark:from-primary-700 dark:to-primary-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white">
            Готов смотреть отзывы по адресам?
          </h2>
          <p className="mt-4 text-lg text-primary-100">
            Открой карту и выбери район или дом — все отзывы в одном месте.
          </p>
          <Link
            href="/map"
      ...
      <footer className="py-8 bg-gray-100 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-6 text-sm">
            ...
            <Link href="/reviews" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
              Отзывы
            </Link>
          </nav>
        </div>
